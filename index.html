                ...
                <table class="uk-table uk-table-middle uk-table-divider">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td id="m3"><script>n=new Date()-50;
                                document.getElementById("m3").innerHTML=n;</script></td>
                            </tr>
                            <tr>
                                <td>Collection Point</td>
                                <td id="c1"></td>
                                <td id="c2">Approved</td>
                                <td id="c3"><script>n=new Date()-30;
                                document.getElementById("c3").innerHTML=n;</script></td>
                            </tr>
                            <tr>
                                <td>Check Point</td>
                                <td id="d1"></td>
                                <td id="d2">Approved</td>
                                <td id="d3"><script>n=new Date()-20;
                                document.getElementById("d3").innerHTML=n;</script></td>
                            </tr>
                            <tr>
                                <td>Merchant</td>
                                <td id="s1"></td>
                                <td id="s2">Rejected</td>
                                <td id="s3"><script>n=new Date()-10;
                                document.getElementById("s3").innerHTML=n;</script></td>
                            </tr>
                        </tbody>
                    </table>
             <center><button class="uk-button uk-button-default uk-width-1-1" style="background-color:red;color:white;"  id="salesforceButton" style="visibility:show" onclick="window.location.href = 'https://fdbotdemo.lightning.force.com/lightning/o/Case/new?nooverride=1&useRecordTypeCheck=1&navigationLocation=LIST_VIEW&backgroundContext=%2Flightning%2Fpage%2Fhome';">Raise Ticket</button></center>
             <center><button class="uk-button uk-button-default uk-width-1-1" style="background-color:green;color:white;" id="mapButton" style="visibility:hidden" onclick="window.location.href = 'http://52.1.79.43:8005/map';">Map</button></center>
